...
namespace PetList
{
    public class Startup
    {
        ...
        {
            services.Configure<PeopleDomainSettings>(Configuration.GetSection("PeopleDomain"));
            services.AddTransient(sp => sp.GetService<IOptionsSnapshot<PeopleDomainSettings>>().Value);
        }
